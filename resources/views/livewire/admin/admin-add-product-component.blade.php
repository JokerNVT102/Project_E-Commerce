            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="addPorduct">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <textarea class="form-cntrol" placeholder="Short Description"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <textarea class="form-cntrol" placeholder="Description"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="number" min="0" placeholder="Regular Price"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="number" min="0" placeholder="Sale Price" class="form-control input-md"
